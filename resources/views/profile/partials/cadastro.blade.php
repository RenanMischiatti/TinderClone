<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 p-4 sm:p-8 dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            <div>
                <x-input-label for="estado" :value="__('Fotos de Perfil')" />
                <input id="foto" name="foto" type="file" class="mt-1 block w-100 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" />
                <x-input-error class="mt-2" :messages="$errors->get('foto')" />
            </div>
            <div id="area-foto" class="row d-flex"></div> 
